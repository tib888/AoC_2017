    ...
    for line in lines {
        ...
        for i in 0..numbers.len() - 1 {
            for j in (i + 1)..numbers.len() {
                let a = cmp::max(numbers[i], numbers[j]);
                let b = cmp::min(numbers[i], numbers[j]);
                if a % b == 0 {
                    sum += a / b;
                }
            }
...
fn main() {
    let day2 = "104	240	147	246	123	175	372	71	116	230	260	118	202	270	277	292
